...
class DriverPerformanceML:
    ...
    FEATURE_NAMES = [
        'toplam_sefer', 'toplam_km', 'ort_tuketim', 'filo_karsilastirma',
        'tuketim_tutarliligi', 'trend_encoded', 'guzergah_cesitliligi',
        'bos_sefer_orani', 'km_per_sefer', 'ton_per_km'
    ]
    ...
    def predict_batch(self, driver_stats_list: List[Dict]) -> List[DriverScorePrediction]:
        """
