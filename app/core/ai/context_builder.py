...
"""
    ...
    async def build_vehicle_context(self, arac_id: int) -> str:
        ...
        try:
            ...
            son_seferler, son_yakitlar = await asyncio.gather(son_seferler_task, son_yakitlar_task)
...
"""
    ...
    async def build_analysis_context(self) -> str:
        ...
        try:
            ...
            filo_ort, araclar, rankings = await asyncio.gather(filo_ort_task, araclar_task, rankings_task)
