...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['sofor_id'], ['soforler.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_seferler_arac_id'), 'seferler', ['arac_id'], unique=False)
    op.create_index(op.f('ix_seferler_periyot_id'), 'seferler', ['periyot_id'], unique=False)
    op.create_index(op.f('ix_seferler_sofor_id'), 'seferler', ['sofor_id'], unique=False)
    op.create_index(op.f('ix_seferler_tarih'), 'seferler', ['tarih'], unique=False)
    op.create_table('yakit_alimlari',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tarih', sa.Date(), nullable=False),
    sa.Column('arac_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_yakit_alimlari_arac_id'), 'yakit_alimlari', ['arac_id'], unique=False)
    op.create_index(op.f('ix_yakit_alimlari_tarih'), 'yakit_alimlari', ['tarih'], unique=False)
    op.create_table('yakit_formul',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('arac_id', sa.Integer(), nullable=False),
    ...
    op.create_table('yakit_periyotlari',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('arac_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['arac_id'], ['araclar.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('arac_id', 'alim1_id', 'alim2_id', name='uq_yakit_periyodu')
    )
