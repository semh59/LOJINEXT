...
class TestKalmanStability:
    ...
    def test_batch_update_limit(self):
        ...
        large_batch = [
            {"features": {"ton": 10}, "consumption": 30.0} for _ in range(1001)
        ]
...
class TestEnsembleModel:
    ...
    def test_untrained_model_fallback(self):
        ...
        sefer = {"mesafe_km": 500, "ton": 20, "ascent_m": 1000, "descent_m": 800}
            ...
            with open(file, "r", encoding="utf-8") as f:
                ...
                for i, line in enumerate(lines, 1):
                    ...
                    if "pickle.load" in line:
                        pytest.fail(f"Güvensiz pickle.load bulundu: {file.name}:{i}")
...
class TestBenchmarkStability:
    ...
    def test_ab_test_zero_mae_handling(self):
        ...
        result = ab.run_ab_test(
            "Perfect Models", "A", perfect_a, "B", perfect_b, actuals, metric="MAE"
        )
